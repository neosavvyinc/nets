...
public class AnnotationPrintHandler implements ISVNAnnotateHandler {
	...
	public void handleLine(Date date, long revision, String author, String line){
		...
		public void handleLine(
				Date date,// - the time moment when changes to line were commited to the repository
			    long revision,// - the revision the changes were commited to
			    String author,// - the person who did those changes
			    String line,// - a text line of the target file (on which doAnnotate() was invoked)
			    ...
			    int lineNumber)
				throws SVNException {
					System.out.println("r" + revision + ":: " + lineNumber +
                 "  " + 
                 author + 
                 "  " + 
                 date + 
		...
		public boolean handleRevision(Date arg0, long arg1,
				String arg2, File arg3) throws SVNException {
