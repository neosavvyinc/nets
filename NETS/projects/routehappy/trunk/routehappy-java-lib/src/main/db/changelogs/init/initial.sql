...
(
  ...
  REVIEW_OPTIONAL_RATING_ID NUMERIC(10)
);
...
(
  ...
  RATING_AIRPORT_ORIG  NUMERIC (2)         NOT NULL,
  RATING_AIRPORT_DEST  NUMERIC (2)         NOT NULL,
  ID                   NUMERIC(10)               NOT NULL,
  SEGMENT              NUMERIC(1)
...
CREATE TABLE RH_REVIEW_OPTIONAL_RATINGS
(
	RATING_ID                   NUMERIC(10),
    DEPT_GET_AIRPORT            NUMERIC(10),
    DEPT_CHECKIN_SECURITY       NUMERIC(10),
    DEPT_FOOD_SHOP              NUMERIC(10),
    DEPT_GATE_BOARDING          NUMERIC(10),
    AIRPORT_LOUGE               NUMERIC(10),
    FIRST_FLIGHT_COMFORT        NUMERIC(10),
    FIRST_FLIGHT_CLEANLINESS    NUMERIC(10),
    FIRST_FLIGHT_CABIN_CREW     NUMERIC(10),
    FIRST_FLIGHT_FOOD           NUMERIC(10),
    FIRST_FLIGHT_ENTERTAINMENT  NUMERIC(10),
    ARRIVAL_GETTING_OFF_PLANE   NUMERIC(10),
    ARRIVAL_BAGGAGE_CLAIM       NUMERIC(10),
    ARRIVAL_BAGGAGE_HANDLING    NUMERIC(10),
    ARRIVAL_IMMIGRATION_CUSTOMS NUMERIC(10),
    LEAVING_AIRPORT             NUMERIC(10)
);
CREATE SEQUENCE rh_review_optional_rating_seq START 1;
