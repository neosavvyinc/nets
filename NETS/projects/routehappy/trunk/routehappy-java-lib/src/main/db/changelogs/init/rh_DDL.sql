...
(
  ...
  YEAR_BORN                NUMBER(4)            NOT NULL,
  FLIGHTS_YEARLY           NUMBER(4)            NOT NULL,
  MEMBER_PHOTO             BLOB,
...
(
  REVIEW_SEGMENT_ID  NUMBER(10)                 NOT NULL,
  REVIEW_CONTENT_ID  NUMBER(10)                 NOT NULL
)
...
(
  ID                  NUMBER(10)                NOT NULL,
  RATING_CATEGORY_ID  NUMBER(10),
  RATING_TYPE_ID      NUMBER(10)                NOT NULL,
...
(
  ...
  RATING_TYPE_ID      NUMBER(10)                NOT NULL,
  RATING              CHAR(1)          NOT NULL,
  RATING_CATEGORY_ID  NUMBER(10)                NOT NULL,
  RATING_SEGMENT_ID   NUMBER(10)
)
