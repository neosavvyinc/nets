package com.neosavvy.user.controller.expenses.report.view {
    ...
    public class FindExpenseReportById extends ResponderAsyncCommand {
        ...
        override public function execute(notification:INotification):void {
            ...
            expenseReportProxy.findExpenseReportById(id, this);
        }
        ...
        override protected function resultHandler(resultEvent:ResultEvent):void {
            ...
            sendNotification(ApplicationFacade.FIND_EXPENSE_REPORT_BY_ID_SUCCESS);
        }
        ...
        override protected function faultHandler(faultEvent:FaultEvent):void {
            ...
            sendNotification(ApplicationFacade.FIND_EXPENSE_REPORT_BY_ID_FAILURE);
        }
