...
SELECT pg_catalog.setval('acl_entry_id_seq', 69, true);
...
SELECT pg_catalog.setval('acl_object_identity_id_seq', 58, true);
...
SELECT pg_catalog.setval('expense_report_id_seq', 1, true);
...
SELECT pg_catalog.setval('expense_report_item_id_seq', 40, true);
...
SELECT pg_catalog.setval('file_refs_id_seq', 4, true);
...
1	\N	New York City	\N	January 2011 Travel	1	2	OPEN
\.
...
COPY users (id, middle_name, last_name, email_address, contact_phone_number, password, username, active, first_name, confirmed_registration, reg_token) FROM stdin;
1		Parrish	aparrish@neosavvy.com	\N	winter69	neosavvy	t	Adam	t	EAF55BE44C1AEB36
3	de	Cavaignac	aparrish@neosavvy.com	\N	test	andre	t	Andre	t	3AC83FF4B2B0965B
2		Parrish	aparrish@neosavvy.com	\N	C20942E4	adamparrish	t	Adam	t	D96C5681A8A518F2
\.
