...
SELECT pg_catalog.setval('acl_entry_id_seq', 1404, true);
...
SELECT pg_catalog.setval('acl_object_identity_id_seq', 534, true);
...
SELECT pg_catalog.setval('acl_sid_id_seq', 12, true);
...
SELECT pg_catalog.setval('expense_report_id_seq', 16, true);
...
SELECT pg_catalog.setval('expense_report_item_id_seq', 270, true);
...
SELECT pg_catalog.setval('file_refs_id_seq', 203, true);
...
SELECT pg_catalog.setval('user_company_role_id_seq', 11, true);
