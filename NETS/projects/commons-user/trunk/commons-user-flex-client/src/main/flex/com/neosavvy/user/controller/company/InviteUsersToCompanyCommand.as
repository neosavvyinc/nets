package com.neosavvy.user.controller.company {
    ...
    public class InviteUsersToCompanyCommand extends SimpleCommand {
        override public function execute(notification:INotification):void {
            ...
            var company:CompanyDTO = params[0] as CompanyDTO;
            var userInvites:ArrayCollection =  params[1] as ArrayCollection;
            companyServiceProxy.inviteUsers( company, userInvites );
