package com.neosavvy.user.controller.expenses.report.view {
    ...
    public class FindAwaitingApprovalExpenseReportsForUserCommand extends ResponderAsyncCommand {
        ...
        override public function execute(notification:INotification):void {
            ...
            expenseReportProxy.findExpenseReportsAwaitingApproval(user, this);
        }

        override protected function resultHandler(resultEvent:ResultEvent):void {
            var expenseReportProxy:ExpenseReportServiceProxy = facade.retrieveProxy(ExpenseReportServiceProxy.NAME) as ExpenseReportServiceProxy;
            expenseReportProxy.awaitingExpenseReportItems = resultEvent.result as ArrayCollection;
            sendNotification(ApplicationFacade.FIND_AWAITING_EXPENSE_REPORTS_FOR_USER_SUCCESS);
        }
        ...
        override protected function faultHandler(faultEvent:FaultEvent):void {
            ...
            sendNotification(ApplicationFacade.FIND_AWAITING_EXPENSE_REPORTS_FOR_USER_FAILURE);
        }
