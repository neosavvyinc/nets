package com.neosavvy.user.controller.expenses.report.workflow {
    ...
    public class ReopenExpenseReport extends ResponderAsyncCommand {
        ...
        override public function execute(notification:INotification):void {
            ...
            if (notification.getBody() is Array && (notification.getBody() as Array).length == 2) {
                ...
                expenseReportProxy.reopenExpenseReportForApproval( expenseReport, comment, this);
            } else {
                throw IllegalOperationError("Parameters to ReopenExpenseReport must be expenseReport:ExpenseReport,comment:String")
            }
        ...
        override protected function resultHandler(resultEvent:ResultEvent):void {
            ...
            sendNotification(ApplicationFacade.REOPEN_EXPENSE_REPORT_SUCCESS);
        }
        ...
        override protected function faultHandler(faultEvent:FaultEvent):void {
            ...
            sendNotification(ApplicationFacade.HIDE_PROGRESS_INDICATOR);
            sendNotification(ApplicationFacade.REOPEN_EXPENSE_REPORT_FAILURE);
        }
