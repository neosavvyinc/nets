var receiptDrillDown = Titanium.UI.createView({
  top:60,
  width:320,
  height:420,
  opacity:1,
...
receiptDrillDown.add(chooserLabel);
...
receiptDrillDown.add(ind);

var gallery = Titanium.UI.createButton({
	backgroundImage:'assets/images/albums-button.png',
	top:0,
	width:229,
	height:42
});
...
var camera = Titanium.UI.createButton({
	backgroundImage:'assets/images/camera-button.png',
	width:229,
	height:46,
	top:43
});
...
receiptDrillDown.add(imageControls);
