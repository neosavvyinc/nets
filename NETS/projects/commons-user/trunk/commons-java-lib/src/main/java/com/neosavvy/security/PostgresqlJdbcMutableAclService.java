...
public class PostgresqlJdbcMutableAclService extends PostgresqlJdbcAclService implements MutableAclService {
    ...
    private String identityQuery = "SELECT currval('acl_sid_id_seq')";
    ...
    private String insertObjectIdentity = "INSERT INTO acl_object_identity "
        + "(id, object_id_class, object_id_identity, owner_sid, entries_inheriting) " + "VALUES (nextval('acl_object_identity_id_seq'), ?, ?, ?, ?)";
     ...
     * #createObjectIdentity(org.springframework.security.acls.objectidentity.ObjectIdentity, org.springframework.security.acls.sid.Sid)} instead).
     *
     * @param oid to find
     *
     ...
     * capabilities for create, update and delete operations of {@link org.springframework.security.acls.MutableAcl}.
     *
     * @param acl DOCUMENT ME!
     *
     * @return DOCUMENT ME!
     *
     * @throws org.springframework.security.acls.NotFoundException DOCUMENT ME!
     */
